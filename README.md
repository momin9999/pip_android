...
### ローカル（Android Studio）
- Android Studio（Koala 以降推奨）で本リポジトリを開く（Gradle 8.11.1 / AGP 8.7 / JDK 17 / compileSdk 35）
- ビルド: Run、または `./gradlew assembleDebug`（出力: `app/build/outputs/apk/debug/app-debug.apk`）
